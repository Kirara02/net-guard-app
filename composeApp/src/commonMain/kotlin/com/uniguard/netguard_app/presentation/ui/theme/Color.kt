package com.uniguard.netguard_app.presentation.ui.theme

import androidx.compose.ui.graphics.Color

val primaryLight = Color(0xFF1976D2)
val onPrimaryLight = Color(0xFFFFFFFF)
val primaryContainerLight = Color(0xFFD3E4FD)
...
val onSecondaryDark = Color(0xFF3700B3)
val secondaryContainerDark = Color(0xFF121212)
val onSecondaryContainerDark = Color(0xFFBB86FC)

val tertiaryDark = Color(0xFFCF6679)
val onTertiaryDark = Color(0xFF1C0408)
val tertiaryContainerDark = Color(0xFF2D1B1F)
val onTertiaryContainerDark = Color(0xFFCF6679)

val errorDark = Color(0xFFCF6679)
val onErrorDark = Color(0xFF1C0408)
val errorContainerDark = Color(0xFF2D1B1F)
val onErrorContainerDark = Color(0xFFCF6679)
...
val outlineDark = Color(0xFF8D8D8D)

// Status Colors
val statusUp = Color(0xFF4CAF50)
val statusDown = Color(0xFFF44336)
val statusUnknown = Color(0xFFFF9800)
val statusResolved = Color(0xFF2196F3)
